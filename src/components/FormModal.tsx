...
import { deleteExam, deleteStudent, deleteSubject, deleteTeacher } from "@/lib/actions";
...
// USE LAZY LOADING
//commenting this and using NEXT.JS dynamically
...
const FormModal = ({
  ...
  const Form = () => {
    ...
    return type === "delete" && id ? (
      ...
      forms[table](setOpen, type, data, relatedData) //using the forms object to get the form dynamically
    ) : (
      "Form not found!"
    );
  };
        ...
        <div className="w-screen h-screen absolute left-0 top-0 bg-black bg-opacity-60 z-50 flex items-center justify-center">
          <div className="bg-white p-4 rounded-md relative w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%]">
            ...
            <div
              ...
              onClick={() => setOpen(false)} //for closing the window
            >
