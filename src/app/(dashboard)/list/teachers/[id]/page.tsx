...
const SingleTeacherPage = async ({
  ...
  const session = await auth(); //updated tsconfig.json file to support top-level await i.e (without async)
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">{teacher._count.classes}</span>
              </div>
            </div>
          </div>
        </div>
